  ...
  return (
    <AppLayout>
      ...
      <div className="px-3 sm:px-4 md:px-6 pt-4 sm:pt-5">
        <div className="bg-gradient-to-r from-primary-800 via-purple-500 to-pink-500 dark:from-primary-800 dark:via-purple-600 dark:to-pink-600 rounded-2xl p-4 sm:p-5 md:p-6 shadow-2xl border-2 border-white/20 dark:border-white/10">
        ...
        <div className="bg-gradient-to-br from-yellow-50 via-orange-50 to-pink-50 dark:from-yellow-900/20 dark:via-orange-900/20 dark:to-pink-900/20 rounded-2xl shadow-lg border-4 border-yellow-300 dark:border-yellow-700 p-4 sm:p-5">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-3 sm:gap-4">
            ...
            <Link
              ...
              className="relative bg-gradient-to-br from-primary-800 to-primary-600 hover:from-primary-800 hover:to-primary-600 text-white rounded-xl p-4 sm:p-5 shadow-lg border-2 border-primary-800 dark:border-primary-800 transform hover:scale-105 transition-all duration-200 flex flex-col items-center gap-2 cursor-pointer"
      ...
      <PageLayout maxWidth="full" padding="none">
        <RailLayout
          right={
            <div className="space-y-4">
              <div className="bg-gradient-to-br from-primary-800 via-primary-700 to-primary-600 dark:from-primary-800 dark:via-primary-700 dark:to-primary-600 rounded-2xl shadow-2xl border-4 border-primary-800 dark:border-primary-800 p-5">
        ...
        >
          <div className="px-3 sm:px-4 md:px-6 py-4 sm:py-6 space-y-4 sm:space-y-6">
            ...
            <div className="flex bg-gradient-to-r from-primary-800 to-purple-50 dark:from-gray-800 dark:to-gray-900 rounded-2xl p-2 w-full sm:w-fit overflow-x-auto scrollbar-hide border-2 border-primary-800 dark:border-gray-700 shadow-lg">
              <button 
                className={`px-4 sm:px-6 py-3 rounded-xl text-sm sm:text-base font-bold transition-all whitespace-nowrap flex-shrink-0 flex items-center gap-2 transform hover:scale-105 ${selectedTab === 'overview' 
                  ? 'bg-gradient-to-r from-primary-800 to-primary-600 text-white shadow-lg scale-105' 
              ...
              <>
                ...
                <div className="mb-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4 sm:gap-6">
                    <div className="bg-gradient-to-br from-primary-800 via-primary-700 to-primary-600 dark:from-primary-800 dark:via-primary-700 dark:to-primary-600 rounded-2xl shadow-2xl border-4 border-primary-800 dark:border-primary-800 p-5 sm:p-6 transform hover:scale-105 transition-transform">
              ...
              <div className="space-y-6">
                ...
                <div className="mb-6">
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <div className="bg-gradient-to-br from-primary-800 via-primary-700 to-primary-600 dark:from-primary-800 dark:via-primary-700 dark:to-primary-600 rounded-2xl shadow-2xl border-4 border-primary-800 dark:border-primary-800 p-6">
                      <div className="flex items-center gap-3 mb-4">
                        <span className="text-2xl">📊</span>
            ...
            {selectedTab === 'alerts' && (
              <div className="space-y-6">
                ...
                <div className="mb-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    <div className="bg-gradient-to-br from-primary-800 via-primary-700 to-primary-600 dark:from-primary-800 dark:via-primary-700 dark:to-primary-600 rounded-2xl shadow-2xl border-4 border-primary-800 dark:border-primary-800 p-5 hover:scale-105 transition-transform">
