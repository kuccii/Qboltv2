      ...
      <div className="bg-gradient-to-r from-blue-600 to-indigo-600 dark:from-blue-700 dark:to-indigo-700 rounded-xl p-4 md:p-5 shadow-lg border border-blue-500 dark:border-blue-600">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            ...
            {subtitle && (
              <p className="text-sm text-blue-100 dark:text-blue-200 mt-1">{subtitle}</p>
            )}
            {chips.length > 0 && (
              <div className="flex flex-wrap gap-2 mt-3">
                {chips.map((chip, idx) => {
                  const color = chip.variant === 'success' ? 'border-green-300 dark:border-green-400 bg-green-50 dark:bg-green-900/30 text-green-800 dark:text-green-200'
                    ...
                    : chip.variant === 'info' ? 'border-blue-300 dark:border-blue-400 bg-blue-50 dark:bg-blue-900/30 text-blue-800 dark:text-blue-200'
